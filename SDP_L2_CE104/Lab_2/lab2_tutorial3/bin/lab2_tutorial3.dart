void main(List<String> arguments)
{
  ...
  //It is double because / operator is used. It converts the answer if necessary to double. If we use ~/ instead, then averageAge would be int.
  ...
  /// MINI-EXERCISES
    ...
    fullname.write(fName);
    fullname.write(" ");
    fullname.write(lName);
    fullname.toString(); 
    print(fullname);
