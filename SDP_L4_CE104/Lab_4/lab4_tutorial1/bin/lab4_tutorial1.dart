...
class Student
{
  Student({fName = 'shruti', lname = 'patel', grade = 0}):this.firstName = 'abc', this.lastName = 'xyz', this.grade = 100;
...
void main(List<String> arguments)
{
  ...
  */
  ...
  //_named constructor 
  User user2 = User(id:-1,name:'anonymous');
  print(user2);
  ...
  */
  ...
  // Challange 1:
  assert(true);
  final Student bert = Student(fName:'bert', grade: 95);
  final Student ernie = Student(fName: 'ernie', grade: 85);
